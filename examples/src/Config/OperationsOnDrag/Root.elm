...
import Config.OperationsOnDrag.InsertAround
...
type Example
    ...
    | InsertAround Config.OperationsOnDrag.InsertAround.Model
...
initialModel =
    ...
    , examples =
        ...
        , InsertAround Config.OperationsOnDrag.InsertAround.initialModel
...
url id =
    case id of
        ...
        2 ->
            "https://raw.githubusercontent.com/annaghi/dnd-list/master/examples/src/Config/OperationsOnDrag/InsertAround.elm"
...
type Msg
    ...
    | InsertAroundMsg Config.OperationsOnDrag.InsertAround.Msg
                    ...
                    (\example ->
                        case ( message, example ) of
                            ...
                            ( InsertAroundMsg msg, InsertAround mo ) ->
                                stepInsertAround
                                    (Config.OperationsOnDrag.InsertAround.update msg mo)
...
stepInsertAround : ( Config.OperationsOnDrag.InsertAround.Model, Cmd Config.OperationsOnDrag.InsertAround.Msg ) -> ( Example, Cmd Msg )
        ...
        |> List.map
            (\example ->
                case example of
                    ...
                    InsertAround mo ->
                        Sub.map InsertAroundMsg (Config.OperationsOnDrag.InsertAround.subscriptions mo)
...
demoView example =
    case example of
        ...
        InsertAround mo ->
            Html.map InsertAroundMsg (Config.OperationsOnDrag.InsertAround.view mo)
