...
url id =
    case id of
        0 ->
            "https://raw.githubusercontent.com/annaghi/dnd-list/master/examples/src/DnD/OperationsOnDrag/InsertAfter.elm"

        1 ->
            "https://raw.githubusercontent.com/annaghi/dnd-list/master/examples/src/DnD/OperationsOnDrag/InsertBefore.elm"

        2 ->
            "https://raw.githubusercontent.com/annaghi/dnd-list/master/examples/src/DnD/OperationsOnDrag/Rotate.elm"

        3 ->
            "https://raw.githubusercontent.com/annaghi/dnd-list/master/examples/src/DnD/OperationsOnDrag/Swap.elm"

        4 ->
            "https://raw.githubusercontent.com/annaghi/dnd-list/master/examples/src/DnD/OperationsOnDrag/Unaltered.elm"
...
type Msg
    ...
    | RotateIncludeMsg Config.OperationsOnDrag.Rotate.Msg
                    ...
                    (\example ->
                        case ( message, example ) of
                            ...
                            ( RotateIncludeMsg msg, Rotate mo ) ->
                                stepRotateInclude (Config.OperationsOnDrag.Rotate.update msg mo)
...
stepRotateInclude : ( Config.OperationsOnDrag.Rotate.Model, Cmd Config.OperationsOnDrag.Rotate.Msg ) -> ( Example, Cmd Msg )
        ...
        |> List.map
            (\example ->
                case example of
                    ...
                    Rotate mo ->
                        Sub.map RotateIncludeMsg (Config.OperationsOnDrag.Rotate.subscriptions mo)
...
demoView example =
    case example of
        ...
        Rotate mo ->
            Html.map RotateIncludeMsg (Config.OperationsOnDrag.Rotate.view mo)
