module ConfigGroups.OperationsOnDrag.InsertAround exposing (Model, Msg, initialModel, main, subscriptions, update, view)
...
config =
    ...
    , groups =
        { listen = DnDList.Groups.OnDrag
        , operation = DnDList.Groups.InsertAround
...
itemView model offset localIndex { group, value, color } =
    let
        ...
        itemId : String
        itemId =
            "InsertAround-" ++ String.fromInt globalIndex
    in
