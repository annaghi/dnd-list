module DnDList.Single.HookCommands.DetectDrop exposing (Model, Msg, initialModel, main, subscriptions, update, view)
...
system =
    DnDList.Single.config
        ...
        |> DnDList.Single.detectDrop DetectDrop
...
itemStyles =
    [ Html.Attributes.style "background-color" "#5b84b1"
