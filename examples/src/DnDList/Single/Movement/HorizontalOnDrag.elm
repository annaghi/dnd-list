module DnDList.Single.Movement.HorizontalOnDrag exposing (Model, Msg, initialModel, main, subscriptions, update, view)
...
system =
    DnDList.Single.config
        |> DnDList.Single.movement DnDList.Horizontal
